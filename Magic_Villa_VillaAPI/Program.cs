...
//Log.Logger = new LoggerConfiguration().MinimumLevel.Debug().WriteTo.File("log/villaLogs.text", rollingInterval:RollingInterval.Day).CreateLogger();
...
builder.Services.AddScoped<IVillaNumberRepository, VillaNumberRespository>();
